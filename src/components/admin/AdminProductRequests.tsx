...
export const AdminProductRequests = ({ requests, onApprove }: AdminProductRequestsProps) => {
        ...
        <tbody className="divide-y divide-gray-50">
          {requests.map(req => (
            <tr key={req.id} className="hover:bg-gray-50 transition-colors">
              ...
              <td className="px-6 py-4 text-sm font-bold text-airbnb-dark">{req.price.toLocaleString()}đ</td>
