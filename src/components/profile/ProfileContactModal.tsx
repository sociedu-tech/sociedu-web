          ...
          >
            ...
            <div className="p-6 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-airbnb-gray tracking-widest">Hồ sơ cá nhân</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-airbnb-gray tracking-widest">Email</p>
              ...
              {user.socialLinks?.linkedin && (
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold text-airbnb-gray tracking-widest">LinkedIn</p>
              ...
              {user.socialLinks?.website && (
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold text-airbnb-gray tracking-widest">Website</p>
