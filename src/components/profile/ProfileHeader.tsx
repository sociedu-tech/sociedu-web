          ...
          <div className="flex-1 space-y-4 w-full">
            <div className="space-y-1">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
                ...
                {user.role === 'mentor' && user.mentorInfo?.verificationStatus === 'verified' && (
                  <div className="flex items-center gap-1 px-2 py-1 bg-blue-50 text-blue-600 rounded-lg text-[10px] font-black uppercase tracking-widest border border-blue-100">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-2">
              {isOwnProfile ? (
                ...
                <>
                  <button className="w-full sm:w-auto px-8 py-2.5 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-100">
                    Kết nối
                  </button>
                  <button className="w-full sm:w-auto px-8 py-2.5 border-2 border-gray-100 text-airbnb-dark rounded-2xl font-bold hover:bg-gray-50 transition-all">
                    Nhắn tin
                  </button>
                </>
              )}
