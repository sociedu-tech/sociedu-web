  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        {orders.map(order => (
          <div key={order.id} className="bg-white rounded-2xl border border-gray-200 p-6 transition-all group relative overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-6">
              ...
              <div className="flex items-center justify-end gap-3 mt-4 lg:mt-0">
                {order.status === 'Chờ xác nhận' ? (
                  <>
                    <button className="px-5 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:bg-primary-hover transition-all">
                      Chấp nhận
                    </button>
                  ...
                  <button className="p-2 hover:bg-gray-100 rounded-lg text-gray-500 transition-colors border border-gray-200 bg-white" title="Xem chi tiết">
                    <Eye size={18} />
                  </button>
                )}
                <button className="p-2 hover:bg-gray-100 rounded-lg text-gray-500 transition-colors border border-gray-200 bg-white" title="Nhắn tin">
      ...
      <div className="flex justify-center mt-6">
         <button className="px-6 py-2.5 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-dark transition-colors">
            Tải thêm đơn hàng
         </button>
      </div>
    </div>
