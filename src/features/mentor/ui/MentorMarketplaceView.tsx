...
function MarketplaceFilters({
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="mb-3 text-[11px] font-bold uppercase tracking-[0.14em] text-gray">Đã xác thực</h3>
      ...
      {allCategories.length > 0 && (
        <div>
          <h3 className="mb-3 text-[11px] font-bold uppercase tracking-[0.14em] text-gray">Lĩnh vực</h3>
      ...
      <div>
        <h3 className="mb-2 text-[11px] font-bold uppercase tracking-[0.14em] text-gray">Giá tối đa</h3>
        <input
          type="range"
          min={priceBounds.min}
    ...
    <div className="min-h-screen bg-white pb-20">
      <section className="relative overflow-hidden border-b border-border bg-surface-muted">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 md:px-6 md:py-20">
          <p className="text-[11px] font-bold  text-primary">Danh bạ mentor sinh viên · Mentoree</p>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-gray md:text-base">
            Tìm anh chị đi trước và chuyên gia đang làm việc trong ngành để được kèm 1-1: đồ án môn học, bài tập lớn,
            đồ án tốt nghiệp, nghiên cứu khoa học, khóa luận và luyện phỏng vấn thực tập.
          </p>
          ...
          >
            ...
            <button type="submit" className="btn-primary inline-flex shrink-0 items-center gap-1.5 rounded-lg px-4 py-2 text-sm">
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="mt-8 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <label className="flex items-center gap-2 rounded-lg border border-border bg-white px-3 py-2 text-sm">
              <span className="hidden text-xs font-semibold uppercase tracking-wide text-gray sm:inline">Sắp xếp</span>
              <select
                value={sortBy}
          ...
          <section className="lg:col-span-3" aria-label="Danh sách mentor">
            {error ? (
              ...
              <div className="rounded-2xl border border-dashed border-border bg-white py-20 text-center">
                ...
                <p className="mt-1 text-sm text-gray">Thử xóa bớt bộ lọc hoặc tìm theo từ khoá khác.</p>
                {activeFilterCount > 0 && (
                  <button
                    type="button"
                  ...
                  return (
                    <li key={mentor.id}>
                      <article className="group h-full rounded-2xl border border-border bg-white p-5 transition hover:border-primary/40">
                        <div className="flex gap-4">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-2 flex items-center gap-3 text-xs">
                              ...
                              <span className="font-semibold text-gray">{info.sessionsCompleted ?? 0} buổi</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="mt-5 flex items-center justify-between border-t border-border pt-4">
                          <div>
                            <p className="text-[10px] font-bold uppercase tracking-widest text-gray">Từ</p>
        ...
        <section className="mt-16 grid gap-6 rounded-2xl border border-border bg-surface-muted p-6 md:grid-cols-3 md:p-10">
          <div className="md:col-span-2">
            <h2 className="text-2xl font-black tracking-tight text-dark md:text-3xl">Mentor Mentoree hỗ trợ sinh viên việc gì?</h2>
            <p className="mt-3 text-sm leading-relaxed text-gray md:text-base">
              Mentor đồng hành với bài tập lớn, đồ án môn học, đồ án tốt nghiệp (ĐATN), nghiên cứu khoa học (NCKH), khóa luận,
              tiểu luận và luyện phỏng vấn thực tập/fresher ở nhiều ngành: CNTT, Kinh tế, Điện - Điện tử, Cơ khí, Xây dựng, Ngoại ngữ,
              Thiết kế, Dữ liệu. Bạn xem được chuyên môn, đánh giá và mức giá trước khi đặt buổi.
            </p>
          </div>
